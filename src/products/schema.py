...
class CreateProduct(graphene.Mutation):
    ...
    class Arguments:
        ...
        # It's graphene.ID not graphene.ID()
        category = graphene.List(graphene.ID)
        is_stock = graphene.Boolean()
    ...
    def mutate(self, info, name, price=None, category=None, in_stock=True, date_created=None):
        ...
        # Loop through and add categories for our product.
...
class UpdateProduct(graphene.Mutation):
    ...
    def mutate(self, info, name, price=None, category=None, in_stock=True, date_created=None):
        ...
        # Loop through and update categories for out product
        if category is not None:
            category_set = []
            for category_id in category:
                category_object = Category.objects.get(pk=category_id)
